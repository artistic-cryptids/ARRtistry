...
interface SoldArtworkInfoProps extends ContractProps {
  artwork: Artwork;
  id: number;
  soldTo: string;
  soldFor: number;
...
interface SoldArtworkInfoState {
  artist: Artist;
  metaUri: string;
...
class SoldArtworkInfo extends React.Component<SoldArtworkInfoProps, SoldArtworkInfoState> {
  ...
  render (): React.ReactNode {
    ...
    const soldTo = this.props.soldTo;
    const soldFor = this.props.soldFor;
      ...
      return (
        <Card className="shadow">
          <Card.Body>
            ...
            <hr/>
            <Card.Text>
              <span className="text-muted text-capitalize">Sold To:</span> {soldTo}
              <br/>
              <span className="text-muted text-capitalize">Sold For:</span> {soldFor}
              <br/>
              <br/>
...
export default SoldArtworkInfo;
